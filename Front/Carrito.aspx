            ...
            <asp:Repeater ID="rptCarrito" runat="server">
                <ItemTemplate>
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2">
                            <!-- Enlace que redirige a DetalleProducto.aspx -->
                            <a href='Productos/DetalleProducto.aspx?id=<%# Eval("id") %>'>
                        ...
                        <div class="col-md-2">
                            ...
                            <asp:TextBox ID="txtCantidad" runat="server" Text='<%# Eval("Cantidad") %>' CssClass="form-control text-center" AutoPostBack="true" OnTextChanged="txtCantidad_TextChanged" ReadOnly="false" />
                        </div>

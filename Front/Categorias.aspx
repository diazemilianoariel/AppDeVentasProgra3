<%@ Page Title="" Language="C#" MasterPageFile="~/MASTER.Master" AutoEventWireup="true" CodeBehind="Categorias.aspx.cs" Inherits="Front.Categorias" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <div class="row mt-4 justify-content-center">
            <asp:HyperLink NavigateUrl="~/CategoriasABM/CategoriaAgregar.aspx" runat="server" CssClass="btn btn-primary">Nueva Categoría</asp:HyperLink>
        </div>
            ...
            <div class="col-md-10">
                <div class="table-responsive">
                    <asp:GridView ID="GridViewCategorias" runat="server"
                        ...
                        AllowPaging="True" PageSize="5" OnPageIndexChanging="GridViewCategorias_PageIndexChanging">
                        <Columns>

<%@ Page Title="Gestión de Usuarios" Language="C#" MasterPageFile="~/MASTER.Master" AutoEventWireup="true" CodeBehind="Clientes.aspx.cs" Inherits="Front.Clientes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <div class="row mt-4 justify-content-center">
            <asp:HyperLink NavigateUrl="~/UsuariosABM/UsuarioAgregar.aspx" runat="server" CssClass="btn btn-primary shadow-sm">Nuevo Usuario</asp:HyperLink>
        </div>
        <div class="row mt-4 justify-content-center">

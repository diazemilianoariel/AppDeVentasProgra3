                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <%-- Campo oculto para guardar el nombre original --%>
                            ...
                            <asp:Label ID="LabelNombre" runat="server" CssClass="form-label fw-bold">Nombre del Perfil:</asp:Label>
                            <asp:TextBox ID="TextBoxNombre" runat="server" CssClass="form-control"></asp:TextBox>
                            
                            <%-- Labels para mostrar mensajes de error específicos --%>

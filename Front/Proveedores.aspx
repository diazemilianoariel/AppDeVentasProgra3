<%@ Page Title="Gestión de Proveedores" Language="C#" MasterPageFile="~/MASTER.Master" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="Front.Proveedores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <div class="row mt-4 justify-content-center">
            <asp:HyperLink NavigateUrl="~/ProveedoresABM/ProveedorAgregar.aspx" runat="server" CssClass="btn btn-primary shadow-sm">Nuevo Proveedor</asp:HyperLink>
        </div>
        <div class="row mt-4 justify-content-center">

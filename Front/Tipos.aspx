<%@ Page Title="Gestión de Tipos" Language="C#" MasterPageFile="~/MASTER.Master" AutoEventWireup="true" CodeBehind="Tipos.aspx.cs" Inherits="Front.Tipos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <div class="row mt-4 justify-content-center">
            <asp:HyperLink NavigateUrl="~/TiposABM/TipoAgregar.aspx" runat="server" CssClass="btn btn-primary shadow-sm">Nuevo Tipo</asp:HyperLink>
        </div>
        <div class="row mt-4 justify-content-center">
